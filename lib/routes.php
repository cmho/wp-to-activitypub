<?php
  ...
  function rewrite_init() {
		...
		$tags_prefix = get_option('wp_activitypub_tags_prefix') ? get_option('wp_activitypub_tags_prefix') : 'tag_';
		$cats_prefix = get_option('wp_activitypub_cats_prefix') ? get_option('wp_activitypub_cats_prefix') : 'cat_';
		$all_name = get_option('wp_activitypub_global') ? get_option('wp_activitypub_global') : 'all';
